...
const PRESETS: Record<string, Partial<GradualBlurProps>> = {
  top: { position: 'top', height: '3rem' },
  bottom: { position: 'bottom', height: '3rem' },
  left: { position: 'left', height: '3rem' },
  right: { position: 'right', height: '3rem' },

  subtle: { height: '4rem', strength: 1, opacity: 0.8, divCount: 3 },
  intense: { height: '10rem', strength: 4, divCount: 8, exponential: true },

  smooth: { height: '8rem', curve: 'bezier', divCount: 6 },
